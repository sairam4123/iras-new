...
async def async_default_captcha_resolver(sd: str, keys: list[str]) -> str:
    return await asyncio.get_event_loop().run_in_executor(None, default_captcha_handler, sd, keys)